...
-- Data for table `inventory`, also in inventory-data.txt file 
...
(
    ...
    message_from integer NOT NULL DEFAULT nextval('message_message_from_seq'::regclass),
    message_to integer NOT NULL DEFAULT nextval('message_message_to_seq'::regclass),
    ...
    CONSTRAINT account_from_fk FOREIGN KEY (message_from)
        ...
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT account_to_fk FOREIGN KEY (message_to)
        REFERENCES public.account (account_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
-- Database on Render.com expires Aug 11, 2023 